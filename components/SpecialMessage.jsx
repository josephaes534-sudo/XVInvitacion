  ...
  return (
    <section className="relative py-28 md:py-36 px-4">
      ...
      <div className="relative max-w-3xl mx-auto">
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-br from-[rgba(0,212,255,0.02)] via-transparent to-transparent pointer-events-none" />

          <div className="absolute top-6 left-6 text-[rgba(0,212,255,0.06)] text-7xl font-serif leading-none select-none pointer-events-none">
            &ldquo;
          </div>
