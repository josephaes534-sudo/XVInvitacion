      ...
      <div className="relative max-w-lg mx-auto">
        ...
        {hasPlaylist ? (
          ...
          >
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-b from-[rgba(0,212,255,0.015)] to-transparent pointer-events-none group-hover:opacity-0 transition-opacity" />
              <div className="relative">
                <motion.div
                  className="w-20 h-20 mx-auto mb-5 rounded-2xl bg-[rgba(0,212,255,0.05)] border border-[rgba(0,212,255,0.1)] flex items-center justify-center group-hover:scale-110 group-hover:rounded-xl transition-all duration-500"
                  whileHover={{ rotate: [0, -10, 10, 0] }}
                  transition={{ duration: 0.5 }}
                >
                  <IoMusicalNotes className="text-3xl" style={{ color: 'rgba(0, 212, 255, 0.6)' }} />
                </motion.div>
          ...
          >
            ...
            <div className="relative">
              <IoMusicalNotes className="text-5xl mx-auto mb-5" style={{ color: 'rgba(0, 212, 255, 0.2)' }} />
              ...
              <p className="text-[rgba(255,255,255,0.2)] text-sm leading-relaxed font-light">
                ...
                <br />
                <span className="text-[rgba(0,212,255,0.3)] text-[10px] tracking-wider uppercase">Configura en src/config/event.js</span>
              </p>
            </div>
          </motion.div>
        )}
