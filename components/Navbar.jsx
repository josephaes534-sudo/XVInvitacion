  ...
  return (
    <motion.nav
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${
        scrolled
          ? 'bg-[rgba(8,38,64,0.7)] backdrop-blur-2xl border-b border-[rgba(255,255,255,0.03)]'
          : 'bg-transparent'
      }`}
    >
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="flex items-center justify-between h-16 md:h-20">
          <button
            ...
            style={{ color: 'rgba(80, 168, 216, 0.8)' }}
          >
            Hallie Aes
          </button>
              ...
              >
                {activeSection === section.id && (
                  <motion.div
                    ...
                    style={{
                      background: 'rgba(80, 168, 216, 0.06)',
                      border: '1px solid rgba(80, 168, 216, 0.08)',
                    }}
          ...
          >
            <div className="flex flex-col gap-1.5">
              <motion.span
                ...
                style={{ color: menuOpen ? 'rgba(80,168,216,0.8)' : 'rgba(255,255,255,0.5)' }}
              />
              <motion.span
              ...
              {sections.map((section) => (
                <button
                  ...
                  className={`block w-full text-left px-5 py-3.5 rounded-2xl text-sm font-medium transition-all duration-300 ${
                    activeSection === section.id
                      ? 'text-white bg-[rgba(80,168,216,0.06)]'
