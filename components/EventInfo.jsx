      ...
      <div className="relative max-w-5xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-4 md:gap-6">
          {details.map((item, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[rgba(0,212,255,0.015)] pointer-events-none" />
              <div className="relative">
                <div className="inline-flex items-center justify-center w-16 h-16 rounded-2xl bg-[rgba(0,212,255,0.06)] text-[rgba(0,212,255,0.7)] mb-5 group-hover:bg-[rgba(0,212,255,0.1)] group-hover:scale-110 group-hover:rounded-xl transition-all duration-500">
                  <item.icon size={24} />
                </div>
        ...
        >
          ...
          >
            <IoLocationOutline size={16} className="group-hover:text-[rgba(0,212,255,0.6)] transition-colors" />
