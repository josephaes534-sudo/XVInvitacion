    ...
    return (
      <section id="rsvp" className="relative py-28 md:py-36 px-4">
        ...
        <div className="relative max-w-lg mx-auto">
          ...
          >
            <div className="absolute inset-0 bg-gradient-to-b from-[rgba(80,168,216,0.02)] to-transparent pointer-events-none" />
            <div className="relative">
              ...
              >
                <IoCheckmarkCircle className="text-6xl mx-auto mb-6" style={{ color: 'rgba(80, 168, 216, 0.7)' }} />
              </motion.div>
            ...
            <div className="relative space-y-6">
              <div>
                <label className="flex items-center gap-2 text-[rgba(255,255,255,0.2)] text-[11px] uppercase tracking-[0.25em] mb-2.5 font-medium">
                  <IoPersonOutline size={14} style={{ color: 'rgba(80, 168, 216, 0.5)' }} />
                  Tu Nombre
                </label>
                <input
                  type="text"
              ...
              <div>
                <label className="flex items-center gap-2 text-[rgba(255,255,255,0.2)] text-[11px] uppercase tracking-[0.25em] mb-2.5 font-medium">
                  <IoPeopleOutline size={14} style={{ color: 'rgba(80, 168, 216, 0.5)' }} />
                  Número de Invitados
                </label>
                <div className="relative">
                  <select
              ...
              <div>
                <label className="flex items-center gap-2 text-[rgba(255,255,255,0.2)] text-[11px] uppercase tracking-[0.25em] mb-2.5 font-medium">
                  <IoChatbubbleOutline size={14} style={{ color: 'rgba(80, 168, 216, 0.5)' }} />
                  Mensaje para Hallie
                </label>
                <textarea
                  name="message"
                ...
                {loading ? (
                  <span className="flex items-center justify-center gap-2">
                    <motion.span
                      ...
                      style={{
                        borderColor: 'rgba(80,168,216,0.6)',
              ...
              {eventConfig.rsvp.phone && (
                <p className="text-center text-[rgba(255,255,255,0.12)] text-xs">
                  ...
                  <a
                    ...
                    className="text-[rgba(80,168,216,0.4)] hover:text-[rgba(80,168,216,0.7)] transition-colors"
                  >
                    {eventConfig.rsvp.phone}
                  </a>
                </p>
