...
function CountdownItem({ value, label }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[rgba(74,176,224,0.02)] pointer-events-none" />
      <div className="absolute top-0 left-1/4 right-1/4 h-[1px] bg-gradient-to-r from-transparent via-[rgba(74,176,224,0.15)] to-transparent" />
      <motion.div
        className="absolute -inset-2 rounded-full opacity-0 group-hover:opacity-100 transition-opacity duration-700"
        style={{
          background: 'radial-gradient(circle at 50% 50%, rgba(74,176,224,0.04), transparent 70%)',
          filter: 'blur(20px)',
        }}
      />
      <motion.span
