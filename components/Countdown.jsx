...
function CountdownItem({ value, label }) {
  ...
  return (
    ...
    >
      <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[rgba(0,212,255,0.02)] pointer-events-none" />
      <div className="absolute top-0 left-1/4 right-1/4 h-[1px] bg-gradient-to-r from-transparent via-[rgba(0,212,255,0.15)] to-transparent" />
      <motion.div
