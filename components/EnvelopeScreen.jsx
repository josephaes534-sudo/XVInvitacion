        ...
        >
          <div className="absolute inset-0 pointer-events-none">
            <motion.div
              ...
              style={{ background: 'radial-gradient(circle, rgba(0,180,255,0.5), transparent 70%)', filter: 'blur(60px)' }}
            />
            <motion.div
              animate={{ opacity: [0.02, 0.05, 0.02] }}
              transition={{ duration: 5, repeat: Infinity, ease: 'easeInOut', delay: 1 }}
              className="absolute bottom-1/3 right-1/4 w-[300px] h-[300px] rounded-full"
              style={{ background: 'radial-gradient(circle, rgba(0,120,200,0.4), transparent 70%)', filter: 'blur(80px)' }}
            />
          </div>
            ...
            <div className="relative" style={{ width: 'min(82vw, 380px)', aspectRatio: '1.35', maxWidth: 380 }}>
              <div
                style={{
                  ...
                  borderRadius: '8px',
                  background: 'linear-gradient(155deg, rgba(215,228,242,0.9) 0%, rgba(195,215,238,0.85) 30%, rgba(180,205,232,0.8) 60%, rgba(205,220,242,0.85) 100%)',
              ...
              >
                ...
                >
                  <div style={{
                    ...
                    background: 'linear-gradient(155deg, rgba(205,222,240,0.95) 0%, rgba(190,210,235,0.9) 50%, rgba(180,200,230,0.85) 100%)',
                ...
                <motion.div
                  animate={{ opacity: phase === 'opening' ? [1, 1, 0] : 1, scale: phase === 'opening' ? [1, 1, 0] : 1 }}
                  transition={{ duration: 0.5, delay: 2.2, ease: 'easeInOut' }}
                  style={{
                    position: 'absolute', bottom: '30%', left: '50%', transform: 'translateX(-50%)',
                    width: '14%', minWidth: 40, maxWidth: 50, aspectRatio: '1', borderRadius: '50%',
                    background: 'radial-gradient(circle at 35% 35%, #c0392b 0%, #96281b 40%, #7a1f14 80%, #5a120a 100%)',
                    boxShadow: phase === 'opening'
                      ? '0 0 50px rgba(200,180,255,0.6), 0 2px 8px rgba(0,0,0,0.3)'
                      : '0 2px 8px rgba(0,0,0,0.3), inset 0 1px 2px rgba(255,200,150,0.3)',
                    zIndex: 2, display: 'flex', alignItems: 'center', justifyContent: 'center',
                    pointerEvents: 'none',
                  }}
                >
                  <span style={{ fontSize: 'clamp(13px, 4vw, 18px)', color: 'rgba(255,255,255,0.5)', fontFamily: 'serif', fontStyle: 'italic' }}>H</span>
                </motion.div>
